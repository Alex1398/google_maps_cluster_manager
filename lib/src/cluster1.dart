...
class Cluster1<T extends ClusterItem> {
  final LatLng location;
  final Iterable<T> items;

  Cluster1(this.items, this.location);

  Cluster1.fromItems(Iterable<T> items)
      : this.items = items,
  ...
  Cluster1.fromClusters(Cluster1<T> cluster1, Cluster1<T> cluster2)
  ...
  bool operator ==(o) => o is Cluster1 && items == o.items;
