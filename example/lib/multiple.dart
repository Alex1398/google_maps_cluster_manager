...
class MapSampleState extends State<MapSample> {
  late ClusterManager1 _manager;
  late ClusterManager1 _manager2;
  ...
  @override
  void initState() {
    _manager = ClusterManager1<Place>(items, _updateMarkers,
        markerBuilder: _getMarkerBuilder(Colors.red));

    _manager2 = ClusterManager1<Place>(items2, _updateMarkers2,
  ...
  Future<Marker> Function(Cluster1<Place>) _getMarkerBuilder(Color color) =>
      (cluster) async {
        return Marker(
